...
export default function Apps() {
  return (
    <div className="scrollbar absolute right-0 top-0 max-h-96 min-w-96 translate-y-10 overflow-y-scroll rounded-xl bg-gray-100 p-2 shadow-lg">
      <div className="grid grid-cols-3 gap-2 rounded-lg bg-white/60 p-4">
        {applications.map((application, index) => (
          <div
            key={index}
            className="flex cursor-pointer items-center justify-center gap-2 rounded-lg p-2 hover:bg-white/50"
          >
